 ...
 * initializing the implementation, admin, and init data.
 */
contract __AdminUpgradeabilityProxy__ is
    __BaseAdminUpgradeabilityProxy__,
    UpgradeabilityProxy
{
    /**
     * Contract constructor.
...
contract Governable is Initializable {
     ...
     */
    function __Governable_init_unchained(
        address governor_
    ) public virtual onlyInitializing /*initializer*/ {
        governor = governor_;
